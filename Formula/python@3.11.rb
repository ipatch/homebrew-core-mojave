class PythonAT311 < Formula
  ...
  def caveats
    <<~EOS
      ...
      on my 2015 mbp it took ~ to build and install python@3.11
      ==> Summary
      /Users/brewmaster/homebrew/Cellar/python@3.11/3.11.9: 8,524 files, 197.5MB, built in 10 minutes 47 seconds
    EOS
  end
